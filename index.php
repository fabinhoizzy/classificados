				...
				<form method="GET">
					...
					<label for="preco">Preço</label>
						<select id="preco" name="filtros[preco]" class="form-control">
							...
							<option value="101-300" <?php echo ($filtros['preco']=='101-300')?'selected="selected"':''; ?>>R$ 101-300</option>
							
							<option value="301-501" <?php echo ($filtros['preco']=='301-501')?'selected="selected"':''; ?>>R$ 301-501</option>
