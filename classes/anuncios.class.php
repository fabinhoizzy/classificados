	...
	public function getUltimosAnuncios($page, $perpage, $filtros){
		...
		$sql = $pdo->prepare("SELECT 
			*,
			...
			(select categorias.nome from categorias where categorias.id = anuncios.id_categoria ) as categoria FROM anuncios WHERE ".implode(' AND ', $filtrostring)." ORDER BY id DESC LIMIT $offset, $perpage");
